...
@Deprecated("It should no longer be used, use instead GoogleSignInFactory",ReplaceWith("GoogleSignInFactory"))
abstract class GoogleSignInFactoryOld<T>(private val context: Context,
